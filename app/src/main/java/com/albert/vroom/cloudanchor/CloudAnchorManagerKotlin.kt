 ...
 */
internal class CloudAnchorManagerKotlin {
    ...
    fun resolveCloudAnchor(
            anchorId: String?, listener: CloudAnchorResolveListener, startTimeMillis: Long) {
    ...
    @Synchronized
    fun onUpdate() {
        session ?: throw NullPointerException("The session cannot be null.")
        val hostIter: MutableIterator<Map.Entry<Anchor, CloudAnchorHostListener>> = pendingHostAnchors.iterator()
        ...
        val resolveIter: MutableIterator<Map.Entry<Anchor, CloudAnchorResolveListener>> = pendingResolveAnchors.iterator()
    ...
    companion object {
        private val TAG = CloudAnchorActivity::class.java.simpleName + "." + CloudAnchorManagerKotlin::class.java.simpleName
